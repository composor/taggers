...
export function taggers(h) {
  const createTag = node(h);
  const exported = { TAG_NAMES, isSelector, createTag };
  TAG_NAMES.forEach(n => {
    /**
     *  Also support a first-letter-uppercase spelling to help avoid conflicts with other variables or Javascript reserved keywords such as 'var'
    */
